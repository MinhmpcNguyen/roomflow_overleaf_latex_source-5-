...
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{1.9cm}|>{\raggedright\arraybackslash}p{3.4cm}|>{\raggedright\arraybackslash}X|}
\hline
\textbf{Operation} & \textbf{Manual score OS / Prompt} & \textbf{Main reading} \\
\hline
Overall & \textbf{0.956} / 0.897 & Object-scope preflight improves semantic edit success; prompt-only stays closer to source structure. \\
\hline
Add & 0.963 / \textbf{0.975} & Both variants usually succeed; the difference is not significant. \\
\hline
Recolor & \textbf{1.000} / 0.775 & Object-scope preflight is clearly better because the target object and color are explicit. \\
\hline
Remove & \textbf{0.975} / 0.963 & The two variants are close, with a small object-scope advantage. \\
\hline
Replace & \textbf{0.887} / 0.875 & Replacement is the hardest operation for both variants. \\
\hline
\end{tabularx}
\end{table}
