\chapter{Theoretical Background for Interior Layout Design and Photorealistic Rendering}

\section{LLM-Assisted Design Understanding and Planning}\label{sec:llm-assisted-planning-and-structured-agents}
...
\section{Constraint-Aware Interior Layout Design}\label{sec:indoor-scene-synthesis-and-asset-grounded-layouts}
...
\section[Layout-Guided Photorealistic Rendering and Image Editing]{\texorpdfstring{Layout-Guided Photorealistic Rendering\\and Image Editing}{Layout-Guided Photorealistic Rendering and Image Editing}}\label{sec:layout-conditioned-image-generation-and-editing}
...
These metrics also have limitations. Pixel-level and structural metrics may punish a successful render when texture, lighting, or material realism changes the image substantially. Conversely, a conservative edit can obtain high edge or depth similarity simply because it changes too little, even if it fails the requested operation. For this reason, Chapter 8 interprets automated image metrics together with preset checks and human edit scoring rather than treating any single metric as a complete judgment of quality.
