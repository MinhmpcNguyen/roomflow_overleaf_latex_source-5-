...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{figures/chapter4/figure_02.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{figures/chapter4/figure_03.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{figures/chapter4/figure_04.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\textwidth]{figures/chapter4/figure_05.png}
...
The project uses a web stack and AI-service integration rather than a single monolithic desktop application. The \hyperref[tab:6-2]{table below} summarizes the main tools and libraries used in the implemented system.
...
\hline
AI services & OpenAI-compatible text and image APIs & Run LLM planning stages, visual preflight, and image generation/editing. \\
\hline
...
Third, the experiment runners reuse these artifacts to evaluate layout generation, image generation, and image editing in Chapter 7. They remain separate from the interactive API path, while sharing the same core schemas and processing modules.

\hyperref[tab:6-3]{Table~6.3} summarizes the implementation scope and the main delivered artifacts. It intentionally describes functional implementation areas instead of exact source-size counts, because algorithmic quality is evaluated separately in Chapter 7.
...
\hline
Evaluation scripts & Layout benchmark, ablation runners, stability evaluation, image-flow evaluation, chart generation, and document figures & Supports the quantitative and qualitative evaluation reported in Chapter 7. \\
\hline
...
Table~\ref{tab:6-4} summarizes the deployment components and the configuration responsibilities for each part.
