...
Besides functional requirements, the system must satisfy several non-functional requirements. These requirements are important because the application combines interactive editing, AI generation, geometric validation, image rendering, and persistent user data. Table~\ref{tab:2-6} summarizes the non-functional requirements used to guide the system design and later implementation choices.
